...
/// <summary>
/// Negates each element in the input block and stores the result in this block.
/// </summary>
public sealed class NegateMapBlock(
    BlockMapBase input,
    float initValue = 0,
    bool dense = false,
    ushort blockSize = 16
) : UnaryBlockMapBase(input, initValue, dense, blockSize)
{
    ...
    {
        TensorPrimitives.Negate(inputBlock, outputBlock);
    }
}
