...
/// <summary>
/// Converts between Entity and JsonNode representations.
/// Used by both RulesDriver and SequenceDriver for serialization/deserialization.
/// </summary>
public static partial class JsonEntityConverter
{
    /// <summary>
    /// Reads an entity and converts it to a JsonNode representation.
    /// </summary>
    public static JsonNode Read(ushort entityIndex)
    {
