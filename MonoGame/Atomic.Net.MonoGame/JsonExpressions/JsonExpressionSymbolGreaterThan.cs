...
public sealed class JsonExpressionSymbolGreaterThan<TIn, TCompare, TOut>(
    IJsonExpression<TIn, TCompare>? left,
    IJsonExpression<TIn, TCompare>? right
) : IJsonExpressionSymbolGreaterThan<TIn, TOut>
{
    ...
    )
    {
        ...
        result = Expression.GreaterThan(leftExpr, rightExpr);
        return true;
    }
}
