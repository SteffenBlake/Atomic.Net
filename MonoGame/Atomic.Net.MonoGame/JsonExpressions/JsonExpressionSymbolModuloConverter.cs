...
/// <summary>
/// JSON converter for JsonExpressionSymbolModulo.
/// </summary>
/// <typeparam name="TIn">Input data type</typeparam>
/// <typeparam name="TOut">Output type produced by the expression</typeparam>
public sealed class JsonExpressionSymbolModuloConverter<TIn, TOut> : JsonConverter<IJsonExpressionSymbolModulo<TIn, TOut>>
{
    public override IJsonExpressionSymbolModulo<TIn, TOut>? Read(
    ...
    )
    {
        ...
        return new JsonExpressionSymbolModulo<TIn, TOut>(dividend, divisor);
    }

    public override void Write(
        Utf8JsonWriter writer,
        IJsonExpressionSymbolModulo<TIn, TOut> value,
        JsonSerializerOptions options
    )
    {
