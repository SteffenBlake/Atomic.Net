...
internal static class ExpressionExtensions
{
    ...
    public static (Expression Left, Expression Right) UnifyExpressionTypes(Expression left, Expression right)
    {
        ...
        // Last resort - convert both to object (necessary for heterogeneous types)
        // This is the only place we use Expression.Convert to object
        var leftAsObj = left.Type == typeof(object) ? left : Expression.Convert(left, typeof(object));
        var rightAsObj = right.Type == typeof(object) ? right : Expression.Convert(right, typeof(object));
