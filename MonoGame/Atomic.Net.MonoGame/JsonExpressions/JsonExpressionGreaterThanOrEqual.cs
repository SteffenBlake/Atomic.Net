...
[JsonConverter(typeof(JsonExpressionGreaterThanOrEqualConverterFactory))]
public sealed class JsonExpressionGreaterThanOrEqual<TIn, TOut>(
...
) : JsonExpression<TIn, TOut>
{
    ...
    )
    {
        ...
        {
            EventBus<ErrorEvent>.Push(new ErrorEvent("GreaterThanOrEqual: Left or Right operand is null"));
            result = null;
            return false;
        }
        ...
        {
            EventBus<ErrorEvent>.Push(new ErrorEvent("GreaterThanOrEqual: Failed to compile Left or Right operand"));
            result = null;
            return false;
        }
        ...
        var comparison = Expression.GreaterThanOrEqual(leftExpr, rightExpr);
