...
/// <summary>
/// JSON converter for JsonExpressionSymbolGreaterThanOrEqual.
/// </summary>
/// <typeparam name="TIn">Input data type</typeparam>
/// <typeparam name="TOut">Output type produced by the expression</typeparam>
public sealed class JsonExpressionSymbolGreaterThanOrEqualConverter<TIn, TOut> : JsonConverter<IJsonExpressionSymbolGreaterThanOrEqual<TIn, TOut>>
{
    public override IJsonExpressionSymbolGreaterThanOrEqual<TIn, TOut>? Read(
    ...
    )
    {
        ...
        return new JsonExpressionSymbolGreaterThanOrEqual<TIn, float, TOut>(left, right);
    }

    public override void Write(
        Utf8JsonWriter writer,
        IJsonExpressionSymbolGreaterThanOrEqual<TIn, TOut> value,
        JsonSerializerOptions options
    )
    {
