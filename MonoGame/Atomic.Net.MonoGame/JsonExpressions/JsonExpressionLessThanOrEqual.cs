...
[JsonConverter(typeof(JsonExpressionLessThanOrEqualConverterFactory))]
public sealed class JsonExpressionLessThanOrEqual<TIn, TOut>(
...
) : JsonExpression<TIn, TOut>
{
    ...
    )
    {
        ...
        var comparison = Expression.LessThanOrEqual(leftExpr, rightExpr);
