...
/// <summary>
/// JSON converter for JsonExpressionEquals.
/// </summary>
/// <typeparam name="TIn">Input data type</typeparam>
/// <typeparam name="TOut">Output type produced by the expression</typeparam>
public sealed class JsonExpressionEqualsConverter<TIn, TOut> : JsonConverter<JsonExpressionEquals<TIn, TOut>>
{
    public override JsonExpressionEquals<TIn, TOut>? Read(
    ...
    )
    {
        ...
        // Deserialize left and right expressions as generic TOut (equality works with any type)
        ...
        return new JsonExpressionEquals<TIn, TOut>(left, right);
    }

    public override void Write(
        Utf8JsonWriter writer,
        JsonExpressionEquals<TIn, TOut> value,
        JsonSerializerOptions options
    )
    {
