...
[JsonConverter(typeof(JsonExpressionNotEqualsConverterFactory))]
public sealed class JsonExpressionNotEquals<TIn, TOut>(
...
) : JsonExpression<TIn, TOut>
{
    ...
    )
    {
        ...
        var comparison = Expression.NotEqual(leftExpr, rightExpr);
