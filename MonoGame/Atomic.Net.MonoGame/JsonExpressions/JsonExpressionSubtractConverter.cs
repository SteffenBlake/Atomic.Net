...
public sealed class JsonExpressionSubtractConverter<TIn, TOut> : JsonConverter<JsonExpressionSubtract<TIn, TOut>>
{
    ...
    )
    {
        ...
        var minuend = JsonSerializer.Deserialize<JsonExpression<TIn, TOut>>(minuendElement, options);
        var subtrahend = JsonSerializer.Deserialize<JsonExpression<TIn, TOut>>(subtrahendElement, options);
        ...
        return new JsonExpressionSubtract<TIn, TOut>(minuend, subtrahend);
    }
