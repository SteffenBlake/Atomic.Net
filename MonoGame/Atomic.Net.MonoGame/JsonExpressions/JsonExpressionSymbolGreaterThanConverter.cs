...
/// <summary>
/// JSON converter for JsonExpressionSymbolGreaterThan.
/// </summary>
/// <typeparam name="TIn">Input data type</typeparam>
/// <typeparam name="TOut">Output type produced by the expression</typeparam>
public sealed class JsonExpressionSymbolGreaterThanConverter<TIn, TOut> : JsonConverter<IJsonExpressionSymbolGreaterThan<TIn, TOut>>
{
    public override IJsonExpressionSymbolGreaterThan<TIn, TOut>? Read(
    ...
    )
    {
        ...
        return new JsonExpressionSymbolGreaterThan<TIn, float, TOut>(left, right);
    }

    public override void Write(
        Utf8JsonWriter writer,
        IJsonExpressionSymbolGreaterThan<TIn, TOut> value,
        JsonSerializerOptions options
    )
    {
