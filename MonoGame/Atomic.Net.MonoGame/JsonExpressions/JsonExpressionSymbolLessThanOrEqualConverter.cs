...
/// <summary>
/// JSON converter for JsonExpressionSymbolLessThanOrEqual.
/// </summary>
/// <typeparam name="TIn">Input data type</typeparam>
/// <typeparam name="TOut">Output type produced by the expression</typeparam>
public sealed class JsonExpressionSymbolLessThanOrEqualConverter<TIn, TOut> : JsonConverter<IJsonExpressionSymbolLessThanOrEqual<TIn, TOut>>
{
    public override IJsonExpressionSymbolLessThanOrEqual<TIn, TOut>? Read(
    ...
    )
    {
        ...
        return new JsonExpressionSymbolLessThanOrEqual<TIn, float, TOut>(left, right);
    }

    public override void Write(
        Utf8JsonWriter writer,
        IJsonExpressionSymbolLessThanOrEqual<TIn, TOut> value,
        JsonSerializerOptions options
    )
    {
