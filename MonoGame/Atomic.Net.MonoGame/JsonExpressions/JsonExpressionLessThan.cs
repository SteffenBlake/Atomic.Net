...
[JsonConverter(typeof(JsonExpressionLessThanConverterFactory))]
public sealed class JsonExpressionLessThan<TIn, TOut>(
...
) : JsonExpression<TIn, TOut>
{
    ...
    )
    {
        ...
        var comparison = Expression.LessThan(leftExpr, rightExpr);
