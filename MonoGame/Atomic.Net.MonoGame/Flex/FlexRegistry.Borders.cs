    ...
    IEventHandler<PreBehaviorRemovedEvent<FlexBorderBottomBehavior>>
{
    ...
    public void OnEvent(BehaviorAddedEvent<FlexBorderLeftBehavior> e)
    {
        ...
        {
            if (_nodes.TryGetValue(e.Entity.Index, out var node)) { node!.StyleSetBorder(Edge.Left, val.Value.Value); }
        }
    }
    ...
    public void OnEvent(PreBehaviorRemovedEvent<FlexBorderLeftBehavior> e)
    {
        _dirty.Set(e.Entity.Index, true);
        if (!_nodes.HasValue(e.Entity.Index)) { _nodes[e.Entity.Index] = FlexLayoutSharp.Flex.CreateDefaultNode(); }
        if (_nodes.TryGetValue(e.Entity.Index, out var node)) { node!.StyleSetBorder(Edge.Left, float.NaN); }
    }
    ...
    public void OnEvent(BehaviorAddedEvent<FlexBorderRightBehavior> e)
    {
        ...
        {
            if (_nodes.TryGetValue(e.Entity.Index, out var node)) { node!.StyleSetBorder(Edge.Right, val.Value.Value); }
        }
    }
    ...
    public void OnEvent(PreBehaviorRemovedEvent<FlexBorderRightBehavior> e)
    {
        _dirty.Set(e.Entity.Index, true);
        if (!_nodes.HasValue(e.Entity.Index)) { _nodes[e.Entity.Index] = FlexLayoutSharp.Flex.CreateDefaultNode(); }
        if (_nodes.TryGetValue(e.Entity.Index, out var node)) { node!.StyleSetBorder(Edge.Right, float.NaN); }
    }
    ...
    public void OnEvent(BehaviorAddedEvent<FlexBorderTopBehavior> e)
    {
        ...
        {
            if (_nodes.TryGetValue(e.Entity.Index, out var node)) { node!.StyleSetBorder(Edge.Top, val.Value.Value); }
        }
    }
    ...
    public void OnEvent(PreBehaviorRemovedEvent<FlexBorderTopBehavior> e)
    {
        _dirty.Set(e.Entity.Index, true);
        if (!_nodes.HasValue(e.Entity.Index)) { _nodes[e.Entity.Index] = FlexLayoutSharp.Flex.CreateDefaultNode(); }
        if (_nodes.TryGetValue(e.Entity.Index, out var node)) { node!.StyleSetBorder(Edge.Top, float.NaN); }
    }
    ...
    public void OnEvent(BehaviorAddedEvent<FlexBorderBottomBehavior> e)
    {
        ...
        {
            if (_nodes.TryGetValue(e.Entity.Index, out var node)) { node!.StyleSetBorder(Edge.Bottom, val.Value.Value); }
        }
    }
    ...
    public void OnEvent(PreBehaviorRemovedEvent<FlexBorderBottomBehavior> e)
    {
        _dirty.Set(e.Entity.Index, true);
        if (!_nodes.HasValue(e.Entity.Index)) { _nodes[e.Entity.Index] = FlexLayoutSharp.Flex.CreateDefaultNode(); }
        if (_nodes.TryGetValue(e.Entity.Index, out var node)) { node!.StyleSetBorder(Edge.Bottom, float.NaN); }
    }
}
