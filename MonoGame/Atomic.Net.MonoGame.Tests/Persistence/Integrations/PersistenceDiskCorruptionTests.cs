...
public sealed class PersistenceDiskCorruptionTests : IDisposable
{
    ...
    public void CorruptJsonInDatabase_FiresErrorEventAndUsesDefaults()
    {
        ...
        BehaviorRegistry<PersistToDiskBehavior>.Instance.SetBehavior(entity, new PersistToDiskBehavior("corrupt-key"));
    ...
    public void MissingDatabaseFile_UsesSceneDefaults()
    {
        ...
        var entity = new Entity(300);
        BehaviorRegistry<PersistToDiskBehavior>.Instance.SetBehavior(entity, new PersistToDiskBehavior("missing-file-key"));
        BehaviorRegistry<PropertiesBehavior>.Instance.SetBehavior(entity, new PropertiesBehavior());
        entity.SetProperty("default-value", 42);
        
        // Assert: Entity should use scene defaults (no error)
        Assert.Equal(42, entity.GetProperty<int>("default-value"));
    ...
    public void PartialEntitySave_DiskHasSubsetOfBehaviors_MergesWithScene()
    {
        ...
        BehaviorRegistry<PersistToDiskBehavior>.Instance.SetBehavior(entity1, new PersistToDiskBehavior("partial-key"));
        BehaviorRegistry<PropertiesBehavior>.Instance.SetBehavior(entity1, new PropertiesBehavior());
        entity1.SetProperty("health", 100);
        ...
        BehaviorRegistry<TransformBehavior>.Instance.SetBehavior(entity2, TransformBehavior.CreateFor(entity2));
        entity2.SetPosition(new(50, 75, 0));
        BehaviorRegistry<PersistToDiskBehavior>.Instance.SetBehavior(entity2, new PersistToDiskBehavior("partial-key"));
        
        // Assert: Entity should have loaded Properties from disk
        // test-architect: Disk had Properties, scene added Transform
        // Assert.Equal(100, entity2.GetProperty<int>("health")); // From disk
    ...
    public void DatabaseLocked_FiresErrorEventAndContinues()
    {
        ...
        var entity = new Entity(300);
        BehaviorRegistry<PersistToDiskBehavior>.Instance.SetBehavior(entity, new PersistToDiskBehavior("locked-key"));
        BehaviorRegistry<PropertiesBehavior>.Instance.SetBehavior(entity, new PropertiesBehavior());
        entity.SetProperty("data", "should-not-write");
    ...
    public void CrossScenePersistence_PersistentPartitionSurvivesReset()
    {
        ...
        BehaviorRegistry<PersistToDiskBehavior>.Instance.SetBehavior(persistentEntity, new PersistToDiskBehavior("persistent-partition-key"));
        BehaviorRegistry<PropertiesBehavior>.Instance.SetBehavior(persistentEntity, new PropertiesBehavior());
        persistentEntity.SetProperty("persistent-value", 999);
        DatabaseRegistry.Instance.Flush();
        ...
        Assert.True(persistentEntity.IsActive);
        Assert.Equal(999, persistentEntity.GetProperty<int>("persistent-value"));
        
        // test-architect: Disk should also have the entity
        // var loadedEntity = LoadEntityFromDatabase("persistent-partition-key");
        // Assert.Equal(999, loadedEntity.GetProperty<int>("persistent-value"));
    }
    ...
    public void CrossScenePersistence_ScenePartitionClearedButDiskPersists()
    {
        ...
        BehaviorRegistry<PersistToDiskBehavior>.Instance.SetBehavior(sceneEntity, new PersistToDiskBehavior("scene-partition-key"));
        BehaviorRegistry<PropertiesBehavior>.Instance.SetBehavior(sceneEntity, new PropertiesBehavior());
        sceneEntity.SetProperty("scene-value", 777);
        DatabaseRegistry.Instance.Flush();
        ...
        Assert.False(sceneEntity.IsActive);
        ...
        // Assert.Equal(777, loadedEntity.GetProperty<int>("scene-value"));
