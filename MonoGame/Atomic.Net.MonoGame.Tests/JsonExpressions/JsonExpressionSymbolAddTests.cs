...
public sealed class JsonExpressionSymbolAddTests : IDisposable
{
    ...
    public JsonExpressionSymbolAddTests(ITestOutputHelper output)
    {
    ...
    public void Add_StringsWithVarData_ReturnsConcatenation()
    {
        ...
        var doc = JsonDocument.Parse(json);
        Assert.True(JsonExpression.TryCompile<PersonRecord, string>(doc, out var expr));
        var func = expr.Compile();
