...
public sealed class JsonExpressionLogTests : IDisposable
{
    ...
    private readonly FakeEventListener<LogEvent> _logListener;

    public JsonExpressionLogTests(ITestOutputHelper output)
    {
        _errorLogger = new ErrorEventLogger(output);
        _errorListener = new FakeEventListener<ErrorEvent>();
        _logListener = new FakeEventListener<LogEvent>();
    }
