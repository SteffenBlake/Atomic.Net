...
/// <summary>
/// Base class for scalar-output block maps that produce a single float value from one or more input blocks.
/// Tracks dirty state and triggers recalculation only when inputs have changed.
/// </summary>
public abstract class FloatMapBase : MapBase
{
